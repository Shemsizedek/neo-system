...
const command={name:'neo',description:'Ask NEOsync from Discord',type:1,options:[{name:'prompt',description:'What do you want NEOsync to do or answer?',type:3,required:true,max_length:2000}]}
