 ...
 * Description: Governed WordPress blocks for NEO telemetry, Noogle, NOMNI, World Library, NEOpass, NEOpay, and Google AI Studio visual surfaces.
 * Version: 4.0.0
 * Author: NEO System
 */
if (!defined('ABSPATH')) exit;

const NEO_TEMPLE_SUITE_VERSION = '4.0.0';
...
function neo_ai_surface_shortcode($atts = array()) {
    ...
    $modules = array('dashboard' => '[neo_temple_dashboard]', 'noogle' => '[neo_noogle_search]', 'nomni' => '[neo_nomni_value]', 'service-status' => '[neo_service_status]', 'apps' => '[neo_app_grid]');
...
function neo_temple_suite_register_blocks() {
    $blocks = array('temple-telemetry' => 'neo_temple_dashboard', 'noogle-search' => 'neo_noogle_search', 'nomni-value' => 'neo_nomni_value', 'service-status' => 'neo_service_status', 'app-grid' => 'neo_app_grid');
