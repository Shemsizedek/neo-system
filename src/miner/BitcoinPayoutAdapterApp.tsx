...
export function BitcoinPayoutAdapterApp(){
  ...
  const[message,setMessage]=useState('Operator authentication is required for live treasury data.')
  useEffect(()=>{setMessage(API?'Production API configured. Treasury details remain protected behind operator authentication.':'Production API URL is not configured in this Pages build.')},[])
  ...
  return <main style={{minHeight:'100vh',background:'#030806',color:'#e8fff0',padding:'32px',fontFamily:'system-ui,sans-serif'}}>
    <div style={{maxWidth:1100,margin:'0 auto'}}>
      ...
      <p style={{marginTop:22,color:'#91ad98',fontSize:14}}>No private key, seed phrase, HSM secret, RPC password, or signer credential is rendered by this page or committed to the repository.</p>
