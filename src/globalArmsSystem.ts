...
export const gasDivisions: GasDivision[] = [
  {
    ...
    functions: ['Strategic warning', 'Source validation', 'Confidence scoring', 'Alternative-analysis review', 'Executive briefs', 'Indicator tracking'],
    readiness: 'GREEN', readinessScore: 92
  },
  {
    id: 'cyber',
    ...
    functions: ['Threat intelligence', 'Security auditing', 'Incident-response planning', 'Identity governance', 'Continuity planning', 'Evidence preservation'],
    readiness: 'GREEN', readinessScore: 88
  },
  {
    id: 'maritime',
    ...
    functions: ['Maritime awareness', 'Port resilience', 'Search-and-rescue planning', 'Shipping-risk analysis', 'Humanitarian routing', 'Supply-route continuity'],
    readiness: 'AMBER', readinessScore: 68
  },
  {
    id: 'aerospace',
    ...
    functions: ['Airspace monitoring', 'Emergency aviation planning', 'Satellite/open imagery analysis', 'Communications resilience', 'Disaster support', 'Navigation-risk assessment'],
    readiness: 'AMBER', readinessScore: 70
  },
  {
    id: 'land',
    ...
    functions: ['Civil-defense planning', 'Evacuation planning', 'Facility resilience', 'Community safety analysis', 'Emergency coordination', 'Shelter planning'],
    readiness: 'GREEN', readinessScore: 85
  },
  {
    id: 'logistics',
    ...
    functions: ['Readiness scoring', 'Supply-chain resilience', 'Medical logistics', 'Continuity planning', 'Resource-gap analysis', 'Reserve planning'],
    readiness: 'GREEN', readinessScore: 87
  },
  {
    id: 'humanitarian',
    ...
    functions: ['Disaster response', 'Displacement monitoring', 'Medical logistics', 'Food and water security', 'Shelter planning', 'Civilian-protection analysis'],
    readiness: 'GREEN', readinessScore: 90
  },
  {
    id: 'policy',
    ...
    functions: ['Policy review', 'Authority mapping', 'Treaty and legal research', 'Use-of-force governance', 'Audit support', 'Civilian-oversight design'],
    readiness: 'GREEN', readinessScore: 91
  }
]
