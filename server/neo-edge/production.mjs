...
function neotericLanding(){
  ...
  :root{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#17211b;background:#f1eee5}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:radial-gradient(circle at 90% 0,#dbe9d8 0,transparent 32%),#f1eee5;color:#17211b}a{color:inherit}.wrap{max-width:1180px;margin:auto;padding:24px}.top{display:flex;justify-content:space-between;align-items:center;gap:18px;padding:12px 0}.brand{font-weight:950;letter-spacing:.13em}.top-actions{display:flex;gap:12px;align-items:center;flex-wrap:wrap}.home-btn{display:inline-flex;align-items:center;justify-content:center;padding:10px 15px;border:1px solid #17211b;border-radius:999px;text-decoration:none;font-weight:850;font-size:.88rem;background:#f8f5ed;color:#17211b}.home-btn:hover{background:#17211b;color:#f8f5ed}.nav{display:flex;gap:16px;align-items:center;flex-wrap:wrap}.nav a{text-decoration:none;font-weight:750;font-size:.9rem}.mobileShop{display:none}.hero{padding:72px 0 42px;display:grid;grid-template-columns:minmax(0,1.35fr) minmax(280px,.65fr);gap:28px;align-items:end}.eyebrow{text-transform:uppercase;letter-spacing:.17em;font-size:.72rem;font-weight:900;color:#55705d}.hero h1{font-size:clamp(3.5rem,10vw,7.8rem);line-height:.84;margin:14px 0 22px;letter-spacing:-.06em}.hero p{font-size:1.12rem;line-height:1.7;max-width:720px;color:#4f5d53}.actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:28px}.btn{padding:14px 18px;border-radius:999px;border:1px solid #17211b;text-decoration:none;font-weight:850}.btn.primary{background:#17211b;color:#f8f5ed}.side{border:1px solid #aeb8aa;border-radius:28px;padding:26px;background:#ffffff8c;box-shadow:0 25px 70px #314b3820}.side b{display:block;font-size:1.25rem;margin-bottom:8px}.side p{font-size:.92rem;line-height:1.6;margin:0;color:#58665c}.side .kicker{font-size:.7rem;letter-spacing:.14em;text-transform:uppercase;font-weight:900;color:#55705d;margin-bottom:14px}.side ul{margin:18px 0 0;padding:0;list-style:none}.side li{padding:9px 0;border-top:1px solid #d4d9d1;font-size:.9rem;font-weight:750}.section{padding:42px 0}.section h2{font-size:clamp(2rem,5vw,3.6rem);margin:0 0 10px;letter-spacing:-.04em}.lead{max-width:760px;line-height:1.7;color:#56645a}.pillars,.fields,.services{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:13px;margin-top:24px}.pillar,.field,.service{border:1px solid #b9c1b7;border-radius:20px;padding:20px;background:#faf9f4cc}.pillar span{display:block;font-size:.7rem;letter-spacing:.12em;color:#738078;margin-bottom:18px}.pillar b{font-size:1.08rem}.field b,.service b{display:block;margin-bottom:8px}.field p,.service p{margin:0;color:#657068;line-height:1.55;font-size:.9rem}.band{margin:34px 0;border-radius:30px;background:#17211b;color:#eef2eb;padding:34px}.band .lead{color:#cbd5cd}.band .btn{border-color:#eef2eb}.band .btn.primary{background:#eef2eb;color:#17211b}.notice{border-left:4px solid #6b8d70;padding:18px 20px;background:#e7eee4;border-radius:0 18px 18px 0;line-height:1.6}.journey{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:24px}.step{padding:22px;border-top:2px solid #17211b}.step span{display:block;font-size:.72rem;letter-spacing:.12em;color:#738078;margin-bottom:12px}.step b{display:block;margin-bottom:7px}.step p{margin:0;color:#657068;font-size:.9rem;line-height:1.55}.foot{padding:38px 0;color:#68736b;font-size:.84rem;border-top:1px solid #c6cbc3;margin-top:38px}@media(max-width:760px){.hero{grid-template-columns:1fr;padding-top:44px}.top{align-items:center;flex-direction:row}.nav a:not(:last-child){display:none}.mobileShop{display:inline-flex}.hero h1{font-size:clamp(3.2rem,18vw,4.3rem)}.wrap{padding:18px}.journey{grid-template-columns:1fr 1fr}.band{padding:26px 22px}}@media(max-width:480px){.journey{grid-template-columns:1fr}}
  </style></head><body><main class="wrap"><header class="top"><div class="brand">NEOTERIC METHOD</div><div class="top-actions"><a class="home-btn" href="https://holytemples.org" aria-label="Return to HolyTemples.org home">← Home</a><a class="home-btn" href="https://holytemples.org/world-bulletin/" aria-label="Open the World Bulletin">World Bulletin</a><nav class="nav"><a href="#method">Method</a><a href="#services">Services</a><a href="#safety">NFM-001</a><a href="https://tabernacle.holytemples.org" rel="noopener">Shop</a></nav></div></header><section class="hero"><div><div class="eyebrow">Noology · Nous Field Therapy · Neotherapy™</div><h1>Know.<br>Reason.<br>Transform.</h1><p>Neoteric Method is the public gateway to Neotherapy™, an applied practice of Noology centered on conscious awareness, disciplined reasoning, intentional reflection and human agency.</p><div class="actions"><a class="btn primary" href="https://tabernacle.holytemples.org" rel="noopener">Enter Shop</a><a class="btn" href="#services">Explore Services</a></div></div><aside class="side"><div class="kicker">Begin with clarity</div><b>A conscious practice, not passive suggestion.</b><p>Explore a structured approach to observation, reasoning, reflection and intentional integration.</p><ul><li>Human agency first</li><li>Consent-led participation</li><li>Evidence boundaries made clear</li><li>Stop or withdraw at any time</li></ul></aside></section><section class="section" id="method"><div class="eyebrow">The framework</div><h2>Seven Pillars</h2><p class="lead">The Neotherapeutic framework organizes practice around seven Noological pillars without treating them as diagnostic categories.</p><div class="pillars">${pillarCards}</div></section><section class="section"><div class="eyebrow">Practice domains</div><h2>Four Fields</h2><div class="fields"><article class="field"><b>Cognitive</b><p>Reasoning, attention, propositions and disciplined examination.</p></article><article class="field"><b>Philosophical</b><p>Meaning, assumptions, knowledge claims and reflective inquiry.</p></article><article class="field"><b>Sensory</b><p>Structured sensory practices governed by safety and evidence controls.</p></article><article class="field"><b>Behavioral</b><p>Intentional integration, practice and observable action.</p></article></div></section><section class="band" id="academy"><div class="eyebrow">Neotherapy Academy</div><h2>Learn the discipline.</h2><p class="lead">Study Noology, Noological Dialogue, logic and cognition, ethics and consent, session methods, research literacy, documentation, privacy and modality-specific practice through the Neoteric learning pathway.</p><div class="actions"><a class="btn primary" href="#method">Explore the Method</a><a class="btn" href="#safety">Review NFM-001</a></div></section><section class="section" id="services"><div class="eyebrow">Services & access</div><h2>One method. Clear boundaries.</h2><div class="services"><article class="service"><b>Noological Dialogue</b><p>Structured inquiry distinguishing fact, perception, hypothesis and unknowns.</p></article><article class="service"><b>Neotherapy Sessions</b><p>Consent-led sessions following the canonical seven-stage Neotherapeutic cycle.</p></article><article class="service"><b>Practitioner Pathway</b><p>Education, practicum, competency assessment and internal credential records.</p></article><article class="service"><b>Research Program</b><p>Evidence-led study with doctrine, hypothesis, observation and validated findings kept distinct.</p></article></div><div class="journey"><article class="step"><span>01 · DISCOVER</span><b>Understand the Method</b><p>Learn the framework, fields and evidence boundaries before choosing an offering.</p></article><article class="step"><span>02 · SELECT</span><b>Choose an Offering</b><p>Use the Tabernacle storefront for available public products and offerings.</p></article><article class="step"><span>03 · CONSENT</span><b>Review Before Practice</b><p>Practice-specific participation uses informed consent and applicable safety screening.</p></article><article class="step"><span>04 · INTEGRATE</span><b>Reflect & Apply</b><p>Use structured reflection and intentional integration rather than passive suggestion.</p></article></div></section><section class="section" id="safety"><div class="eyebrow">NFM-001</div><h2>True Green Light</h2><div class="notice"><b>Experimental Noological sensory practice.</b> NFM-001 is not presented as having established clinical efficacy. Participation requires informed consent, appropriate safety screening, conservative equipment use and the ability to stop at any time. Neotherapy credentials do not themselves confer state healthcare licensure.</div></section><section class="band"><div class="eyebrow">Neoteric storefront</div><h2>Explore Neoteric Method.</h2><p class="lead">Browse available Neoteric Method products and public offerings through the Tabernacle storefront. Practice records remain separate from commerce.</p><div class="actions"><a class="btn primary" href="https://tabernacle.holytemples.org" rel="noopener">Enter Tabernacle Store</a><a class="btn" href="#services">How It Works</a></div></section><footer class="foot">Neoteric Method · Neotherapy™ · Applied Noology<br><span>Education, wellness practice, research and commerce are presented with their respective professional and evidentiary boundaries.</span></footer></main></body></html>`;
}
...
export async function startNeoEdgeProduction(){
  ...
  const front=http.createServer(async(req,res)=>{
    ...
    if(host==='leaders.holytemples.org'&&req.method==='GET'&&(url.pathname==='/'||url.pathname==='/ui'))return renderWorldLeaders(res, url.pathname);
