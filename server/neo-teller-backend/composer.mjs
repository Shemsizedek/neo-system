...
export function normalizeComposition(payload,intent){
  ...
  return {intentId,intent,unsignedTransaction:unsigned,signing:{mode:'USER_CONTROLLED',backendHasPrivateKey:false,backendCanSign:false},broadcast:{enabled:false,status:'NOT_SUBMITTED'},composerMetadata:{btcFee:result?.btc_fee??result?.fee,txSize:result?.tx_size,data:result?.data}}
}
